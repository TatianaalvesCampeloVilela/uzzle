...
exports.computeCashFlowFromDb = computeCashFlowFromDb;
/**
 * Fluxo de Caixa
 * Apenas transações que movem caixa (contas 1.x - Banco)
 */
// ✅ FUNÇÃO PURA - SEM acesso ao banco
function calculateCashFlow(ledgerEntries, period, openingBalance) {
    ...
    var closingBalance = openingBalance + inflows - outflows;
    return {
        period: period,
...
function computeCashFlowFromDb(pool, period, openingBalance) {
    return __awaiter(this, void 0, void 0, function () {
        var rows;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pool.query("SELECT * FROM ledger \n     WHERE date >= $1::date \n       AND date < ($1::date + interval '1 month')\n     ORDER BY date ASC", ["".concat(period, "-01")])];
                case 1:
                    rows = (_a.sent()).rows;
                    return [2 /*return*/, calculateCashFlow(rows, period, openingBalance)];
            }
        });
    });
}
